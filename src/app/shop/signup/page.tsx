...
import { Mail, Lock, User, ArrowRight, Loader2, UserPlus, Phone } from 'lucide-react';
        ...
        <div className="min-h-screen bg-transparent flex items-center justify-center p-4 pt-32 pb-20">
            ...
            >
                <div className="flex flex-col items-center text-center mb-10">
                    ...
                    <h1 className="text-4xl font-black mb-2">Join Pentabrood</h1>
                    <p className="text-muted-foreground font-medium">Create an account to start your journey.</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="space-y-2">
                        ...
                        <div className="relative group">
                            <User className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-neutral-400 group-focus-within:text-purple-600 transition-colors" />
                            <input
                                type="text"
                                value={name}
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative group">
                            <Phone className="absolute left-4 top-1/2 -translate-y-1/2 w-4 h-4 text-neutral-400 group-focus-within:text-purple-600 transition-colors" />
                            <input
                                type="tel"
                                value={phone}
                    ...
                    <div className="text-center mt-8">
                        <p className="text-muted-foreground font-medium">
                            Already have an account? <Link href="/shop/login" className="text-purple-600 font-black hover:underline ml-1 cursor-pointer">Log in</Link>
                        </p>
                    </div>
                </form>
            </motion.div>
